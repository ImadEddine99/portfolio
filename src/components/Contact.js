...
axios.post('http://localhost:3001/api/user/save',inputs).then(function(response){
              ...
              {({ isVisible }) =>
                ...
                <form  onSubmit={handleSubmit}>
                  <Row>
                    ...
                    <Col size={12} sm={6} className="px-1">
                      <input name="last_name" type="text" value={formDetails.lasttName} placeholder="Last Name" onChange={(e) => onFormUpdate('lastName', e.target.value)}/>
                    </Col>
                    <Col size={12} sm={6} className="px-1">
